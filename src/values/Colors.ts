...
const playViewThemes:Array<Record<string,string>> = [
    {card:"#DDFFFE",accent:"#F5AAF8"},
    {card:"#C6B5FF",accent:"#D6FDB5"},
    {card:"#FFDDDD",accent:"#F5AAF8"},
    {card:"#FF9898",accent:"#AAF8C5"},
    {card:"#FFF09F",accent:"#F5AAF8"},
    {card:"#39FFBA",accent:"#693CFF"},
]
